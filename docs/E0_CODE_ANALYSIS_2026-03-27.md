...
- ω = ½(v_rot(x,y) − v_rot(y,x)) is the unique antisymmetric phase generator (C14, within axioms A1/A3/A4)
- P(z) = I(z)/ΣI satisfies axioms B1–B5 and is the unique minimal realization rule (C17, under BER-1–5)
