...
**Current WP-GATE-0.9 collection:** **7044 tests** across **173 test files**; the 204 tests added since the last full execution were exercised in focused suites, not yet in another full-suite run.
...
**WP-GATE-0.9 scope:** Development-only parent-versus-paired pilot isolates synchronous branch instrumentation as the timeout confound, proves real low-margin activation and harm on one bounded wall-grid case, and keeps verification/holdout closed.
...
| **Current collected total (authoritative; not the sum of historical rows)** | **7034** | **172 files; last full execution: 6840** |
