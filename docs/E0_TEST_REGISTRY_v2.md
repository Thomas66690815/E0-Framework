...
**Current WP-GATE-0.13 collection:** **7125 tests** across **179 test files**; the 285 tests added since the last full execution were exercised in focused suites, not yet in another full-suite run.
...
**WP-GATE-0.12 scope:** Implements the outcome-blind sampler, separate Stage-A/Stage-B cell plans, artifact contracts, joint fail-closed statistics, and a manual planning-only GitHub workflow without exposing an outcome command or instantiating a fresh split.
