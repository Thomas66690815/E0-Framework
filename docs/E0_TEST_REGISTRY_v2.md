...
**Current WP-GATE-0.10 collection:** **7052 tests** across **174 test files**; the 212 tests added since the last full execution were exercised in focused suites, not yet in another full-suite run.
...
**WP-GATE-0.10 scope:** Development-only Stage-A/Stage-B prototype separates bounded paired evidence from branch-free parent timing, passes parent-summary and decision-trace invariance at all three scales, and keeps calibration/verification/holdout closed.
...
| **Current collected total (authoritative; not the sum of historical rows)** | **7052** | **174 files; last full execution: 6840** |
