...
**Current WP-GATE-0.7 collection:** **7034 tests** across **172 test files**; the 194 tests added since the last full execution were exercised in focused suites, not yet in another full-suite run.
...
**WP-GATE-0.7 scope:** Commit-bound external authorization, deterministic 144-cell calibration distribution, one complete cell per GitHub job, latest-attempt selection without fallback, complete gated consolidation, protected namespaces absent, and no calibration execution.
...
| `test_override_gate_calibration_pipeline.py` | 24 | WP-GATE-0.6 bounded worker/shards/resume |
| `test_override_gate_calibration_statistics.py` | 21 | WP-GATE-0.6 frozen selection |
