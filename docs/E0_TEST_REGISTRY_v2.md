...
**Current WP-GATE-0.3 collection:** **6906 tests** across **167 test files**; the 66 tests added since the last full execution were exercised in focused suites, not yet in another full-suite run.
...
**WP-GATE-0.3 scope:** Frozen scoped calibration instance, fresh disjoint split manifests, exact candidates, utility/risk/selection rules, non-executing validator, and unchanged runtime defaults.
...
| **Current collected total (authoritative; not the sum of historical rows)** | **6906** | **167 files; last full execution: 6840** |
