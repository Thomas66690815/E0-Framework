...
**Last updated:** 2026-07-29 — **6840 tests** (6838 passed, 2 skipped, 0 failed) across **164 test files**
...
- `e0_controller/test_g1_ablations.py` — 32 tests plus 15 subtests
...
✅ Bounded local/distributed execution and recovery/statistics contracts
confirmed. **Push and manual GitHub dispatch remain pending; the 1,560 corrected
replicates, result report, and frozen primary-control choice do not yet exist.
...
| `test_g1_ablations.py` | 32 | C326 / WP-2.3 |
...
| **Current executed total (authoritative; not the sum of historical rows)** | **6840** | **164 files** |
