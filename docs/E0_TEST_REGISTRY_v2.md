...
**Current WP-GATE-0.16 collection:** **7166 tests** across **181 test files**; the 326 tests added since the last full execution were exercised in focused suites, not yet in another full-suite run.
