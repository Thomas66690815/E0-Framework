...
**Current WP-GATE-0.11 collection:** **7077 tests** across **175 test files**; the 237 tests added since the last full execution were exercised in focused suites, not yet in another full-suite run.
...
**WP-GATE-0.11 scope:** Immutable v2 design freezes fresh split ranges, outcome-blind bounded Stage-A sampling, branch-free Stage-B timing, joint fail-closed selection, missingness, and authorization boundaries without executing a fresh split.
...
| **Current collected total (authoritative; not the sum of historical rows)** | **7077** | **175 files; last full execution: 6840** |
