...
**Current WP-GATE-0.5 collection:** **6976 tests** across **169 test files**; the 136 tests added since the last full execution were exercised in focused suites, not yet in another full-suite run.
...
**WP-GATE-0.5 scope:** Calibration-only seed namespace, exact frozen-policy E_FULL_GEOMETRY adapter, complete-state snapshot, deterministic non-mutating paired branches, protected namespaces absent, and no matrix execution.
...
| **Current collected total (authoritative; not the sum of historical rows)** | **6976** | **169 files; last full execution: 6840** |
