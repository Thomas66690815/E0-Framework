...
**Current WP-GATE-0.6 collection:** **7021 tests** across **171 test files**; the 181 tests added since the last full execution were exercised in focused suites, not yet in another full-suite run.
...
**WP-GATE-0.6 scope:** Bounded calibration-only worker, hard limits, atomic shards, strict resume and whole-cell retries, frozen clustered selection, planning-only GitHub workflow, protected namespaces absent, and no calibration execution.
...
| **Current collected total (authoritative; not the sum of historical rows)** | **7021** | **171 files; last full execution: 6840** |
