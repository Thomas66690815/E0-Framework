...
**Current C331 collection:** **6848 tests** across **165 test files**; the eight tests added since the last full execution were exercised in focused suites, not yet in another full-suite run.
...
**C331 scope:** Development-only G1 mechanism diagnosis: full-evidence override/phase aggregation, bounded per-decision gate blockers, pairwise score/preference/selection divergence, and a non-prescriptive confidence-threshold reachability sweep.
