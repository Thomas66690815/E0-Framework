...
**Current WP-GATE-0.12 collection:** **7112 tests** across **178 test files**; the 272 tests added since the last full execution were exercised in focused suites, not yet in another full-suite run.
