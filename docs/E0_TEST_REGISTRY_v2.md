...
**Current WP-GATE-0.1 collection:** **6848 tests** across **165 test files**; the eight tests added since the last full execution were exercised in focused suites, not yet in another full-suite run.
...
**WP-GATE-0.1 scope:** Design-only override-gate semantics, legacy-policy inventory, migration contract, and calibration protocol. No runtime default or test count changed.
...
| **Current collected total (authoritative; not the sum of historical rows)** | **6848** | **165 files; last full execution: 6840** |
