...
**Current WP-GATE-0.4 collection:** **6937 tests** across **168 test files**; the 97 tests added since the last full execution were exercised in focused suites, not yet in another full-suite run.
...
**WP-GATE-0.4 scope:** Domain-free execution scaffold, deterministic tasks/matrix, explicit disabled-control pairing, protected-split authorization, artifact contracts, sealed dry run, and no outcome command.
...
| **Current collected total (authoritative; not the sum of historical rows)** | **6937** | **168 files; last full execution: 6840** |
