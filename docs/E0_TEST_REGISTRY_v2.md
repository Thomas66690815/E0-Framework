...
**Current WP-GATE-0.2 collection:** **6883 tests** across **166 test files**; the 43 tests added since the last full execution were exercised in focused suites, not yet in another full-suite run.
...
**WP-GATE-0.2 scope:** Immutable override policies, exact legacy mappings, fail-closed guards, policy-controlled dynamic guards, Envelope/MemOS migration, and unchanged runtime defaults.
...
| **Current collected total (authoritative; not the sum of historical rows)** | **6883** | **166 files; last full execution: 6840** |
