...
**Current WP-GATE-0.8 collection:** **7036 tests** across **172 test files**; the 196 tests added since the last full execution were exercised in focused suites, not yet in another full-suite run.
...
**WP-GATE-0.8 scope:** Executed calibration evidence frozen locally with full hashes, scoped negative result documented, three-stage disagreement funnel made explicit for future shards, and verification/holdout still closed.
