...
**Current WP-GATE-0.14 collection:** **7149 tests** across **180 test files**; the 309 tests added since the last full execution were exercised in focused suites, not yet in another full-suite run.
...
**WP-GATE-0.14 scope:** Adds killable development workers, immutable attempts, and a fail-closed external authorization validator to the existing no-outcome sampler/planner/statistics layer; no production outcome command or fresh-split builder exists.
