...
**Current WP-GATE-0.15 collection:** **7166 tests** across **181 test files**; the 326 tests added since the last full execution were exercised in focused suites, not yet in another full-suite run.
...
**WP-GATE-0.15 scope:** Adds the complete calibration-only execution layer and manual Stage-B-then-Stage-A workflow behind the fail-closed external validator; no authorization exists, no workflow was dispatched, and no fresh-split outcome was observed.
...
| **Current collected total (authoritative; not the sum of historical rows)** | **7112** | **178 files; last full execution: 6840** |
