...
| **WP-2.4** | Skalierungslauf + Report `docs/research/E0_DECISION_BENCHMARK_v1.md` — positive und negative Resultate, Effektgrößen und Unsicherheit berichten | Vollständige Tabellen + Rohdatenbundle; Gate-G1-Kriterien darauf anwendbar | in Arbeit C327 (Runner bereit; Vollauf ausstehend) |
