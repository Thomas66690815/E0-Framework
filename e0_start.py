...
# Re-export from e0_system for backward compatibility.
# New code should import directly from e0_system.
from e0_system import (
    compute_metrics,
    format_signature,
    detailed_trace,
    load_canon,
...
# compute_metrics, format_signature, detailed_trace, load_canon
# → now defined in e0_system.py, imported above
...
# E0APIStarter → now defined in e0_system.py, imported above
