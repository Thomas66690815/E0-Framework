...
- [Test Registry v2](docs/E0_TEST_REGISTRY_v2.md) — complete per-file test inventory (2788 tests)
...
**Tests:** 2788 total (pytest discover), 0 failures, 0 warnings, 41 conditional (live LLM — require API key). See [`docs/E0_TEST_REGISTRY_v2.md`](docs/E0_TEST_REGISTRY_v2.md) for per-file details.
...
│   └── test_*.py                       2788 tests (see docs/E0_TEST_REGISTRY_v2.md)
│
...
│   ├── E0_TEST_REGISTRY_v2.md            Complete test inventory (2788 tests)
