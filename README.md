...
- [Test Registry v2](docs/E0_TEST_REGISTRY_v2.md) — complete per-file test inventory (3782 tests)
...
```bash
# Full test suite (3782 tests, pytest):
...
│   └── test_*.py                       3782 tests (see docs/E0_TEST_REGISTRY_v2.md)
│
...
│   ├── E0_TEST_REGISTRY_v2.md            Complete test inventory (3782 tests)
