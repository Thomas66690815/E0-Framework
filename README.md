...
- dream mode with Hungarian-optimal cross-domain pattern discovery and compatibility gating (C109â€“C139, C168),
...
- human communication layer with learnable perception ontology (C158â€“C162),
...
- **Dream Mode (C109â€“C139, C168)** â€” Passive cross-domain pattern recognition. `DreamObserver` monitors N domains, computes edge fingerprints and node-level equivalences (WL recursive + Hungarian optimal assignment), and generates bridge hypotheses. **Compatibility gating (C168):** mean WL distance under Hungarian assignment pre-filters domain pairs â€” incompatible pairs (distance > threshold) are skipped, reducing noise by ~59% (edge-EQ) and ~67% (node-EQ). No active navigation â€” dreaming is observation, not action.
...
- [Architecture overview v4](docs/E0_ARCHITECTURE_OVERVIEW_v4.md) â€” 14-layer model with all 70+ production modules
...
- [Test Registry v2](docs/E0_TEST_REGISTRY_v2.md) â€” complete per-file test inventory (4112 tests)
- [Empirical Insights](docs/E0_EMPIRICAL_INSIGHTS_v1.md) â€” what Chess (C72) reveals about Eâ‚€ as a whole
- [Dream Mode Concept](docs/E0_DREAM_MODE_CONCEPT_v1.md) â€” cross-domain pattern recognition through passive observation (C109â€“C139, C168â€“C171)
- [Multi-Domain Dream Analysis](docs/E0_MULTI_DOMAIN_DREAM_ANALYSIS_v1.md) â€” compatibility gating empirical analysis (C168â€“C171, all 4 questions closed)
- [Asymmetric Teaching Research](docs/research/E0_ASYMMETRIC_TEACHING_RESEARCH_v1.md) â€” training effect=0, topology dominates (C171)
- [Strategic Roadmap](docs/E0_STRATEGIC_ROADMAP_v1.md) â€” post-C171 priorities: adversarial stability â†’ semantic binding â†’ N-domain mesh
...
- [Human Communication Design](docs/E0_HUMAN_COMMUNICATION_DESIGN_v1.md) â€” learnable perception + intent + UISpec emission (C158â€“C162)
...
| Dream Mode (C109â€“C112, C168) | **Active** (113 tests) | `e0_controller/dream_mode.py` |
...
| Parameter Sensitivity (C150â€“C153) | **Active** (66+35 tests) | `e0_controller/parameter_sensitivity.py`, `perspective_diagnostic.py` |
...
| Curriculum â†” Sleep-Wake (C156) | **Active** (14 tests) | `e0_controller/curriculum.py` |
| Dream â†’ CouplingRouter (C157) | **Active** (15 tests) | `e0_controller/coupling_router.py` |
...
**Tests:** 4112 total (pytest), 0 failures, 0 warnings, 41 conditional (live LLM â€” require API key). See [`docs/E0_TEST_REGISTRY_v2.md`](docs/E0_TEST_REGISTRY_v2.md) for per-file details.
...
```bash
# Full test suite (4112 tests, pytest):
...
â”‚   â”œâ”€â”€ dream_mode.py                   Dream Mode: cross-domain pattern recognition + compatibility gating (C109â€“C139, C168)
...
â”‚   â””â”€â”€ test_*.py                       4112 tests (see docs/E0_TEST_REGISTRY_v2.md)
â”‚
...
â”‚   â”œâ”€â”€ E0_ARCHITECTURE_OVERVIEW_v4.md    14-layer module map (70+ modules)
...
â”‚   â”œâ”€â”€ E0_TEST_REGISTRY_v2.md            Complete test inventory (4112 tests)
