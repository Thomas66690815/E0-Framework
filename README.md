...
- [Test Registry v2](docs/E0_TEST_REGISTRY_v2.md) — complete per-file test inventory (3796 tests)
...
```bash
# Full test suite (3796 tests, pytest):
...
│   └── test_*.py                       3796 tests (see docs/E0_TEST_REGISTRY_v2.md)
│
...
│   ├── E0_TEST_REGISTRY_v2.md            Complete test inventory (3796 tests)
