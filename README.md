...
- [Test Registry v2](docs/E0_TEST_REGISTRY_v2.md) — complete per-file test inventory (4196 tests)
...
**Tests:** 4196 total (pytest), 0 failures, 0 warnings, 41 conditional (live LLM � require API key). See [`docs/E0_TEST_REGISTRY_v2.md`](docs/E0_TEST_REGISTRY_v2.md) for per-file details.
...
```bash
# Full test suite (4196 tests, pytest):
...
│   └── test_*.py                       4196 tests (see docs/E0_TEST_REGISTRY_v2.md)
│
...
│   ├── E0_TEST_REGISTRY_v2.md            Complete test inventory (4196 tests)
